...
hist(actSteps$steps, col="lightblue", 
                     xlab = "Total Steps", 
                     ylab = "Frequency",
...
Make a times series plot (i.e., type="l") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
...
#### 4.2.Devise a strategy for filling in all of the missing values in the dataset. The strategy does not need to be sophisticated.  For example, you could use the mean/median for that day, or the mean for that 5-minute interval.
...
#### 4.4. Make a histogram of the total number of steps taken each day and Calculate and report the mean and median total number of steps taken per day.  Do assignment?  What is the impact of imputing missing data on the estimates of the total daily number of steps?
...
hist(actSteps$steps, col="navyblue", 
                     xlab = "Total Steps", 
                     ylab = "Frequency",
                     ylim = c(0,40),
                     cex = 1.0,
...
hist(amiMrgsteps$steps, col="lightgreen", 
                     xlab = "Total Steps", 
                     ylab = "Frequency",
                     ylim = c(0,40),
                     cex = 1.0,
...
ggplot(newamiMrg, aes(x=interval, y=steps)) + geom_line(color="navyblue", size=1) +
